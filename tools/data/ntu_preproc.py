...
sys.path.append('C:/Users/Rojin/PycharmProjects/ActionRecognition')
from pyskl.smp import mrlines

eps = 1e-3


def parse_skeleton_file(ske_name, root='tools/data/SmallDataset'):
...
dump(dict(split=split, annotations=annotations), 'ntu5.pkl')
